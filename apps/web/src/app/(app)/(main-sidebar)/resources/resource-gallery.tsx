...
export default function ResourceGallery({ data }: { data: Resource[] }) {
  ...
  return (
    <div className=" mx-auto">
      ...
      {/* <main className="grid grid-cols-1 gap-2 max-w-[70rem] sm:grid-cols-1 md:grid-cols-2 xl:grid-cols-3 xl:gap-10 "> */}
      <main className="grid gap-3 gap-x-0 md:grid-cols-2 lg:grid-cols-3 justify-center items-center">
