...
export const navigation: NavigationProps[] = [
  ...
  {
    title: "Courses (comming soon)",
   
    href: "/courses",
    links: [
      // {
      //   title: "Next Auth",
      //   href: "/guides/authjs-v5-in-nextjs15",
      //   label: "Updated",
      // },
      // {
      //   title: "Razorpay nextjs",
      //   href: "/guides/razorpay-in-nextjs-15-the-no-bs-way",
      // },
      // // { title: "Stripe", href: "/guides/stripe" },
      // {
      //   title: "Prisma Basics",
      //   href: "/guides/prisma-orm-basics-in-nextjs-15",
      // },
