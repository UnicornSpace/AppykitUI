---
title: Modal
description: A pop-up overlay used to display content above the main screen.
---
...
<Step>
Create a folder named `ui` under component folder in your project and add the following code in a file named `modal.tsx`:
```ts
...
Please follow the installation guide [here](/components/text) before using the `Modal`.
