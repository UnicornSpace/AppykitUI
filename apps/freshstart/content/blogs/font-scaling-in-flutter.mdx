---
title: Flutter textScale Factor Explained
...
isPublished: true
isContentReady: true
thumbnail : '/text_scale_factor.png'
---
...
textScaleFactor is not a bug.  

Your layout must decide whether to control scaling or adapt to it.

If you'd like, I can make a dedicated post on building flexible layouts in Flutter that handle font scaling properly.
</Callout>
