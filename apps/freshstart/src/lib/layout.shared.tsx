...
import Preview from "./../../public/Flutter-appykit-blog-thumbnail.png";
    ...
    links: [
      {
        type: "custom",
        children: (
          <Link href={"/"} className=" text-xl font-light  font-bbh flex items-center">
...

      {
        ...
        children: (
          <NavbarMenu>
            ...
            <NavbarMenuContent>
              <NavbarMenuLink href="/course" className="md:row-span-2">
