...
export function DocsSidebar({ tree }: DocsSidebarProps) {
  ...
  return (
    <>
      <div className="border-b border-border/60 bg-background/95 lg:hidden">
      ...
      <aside className="sticky top-14 hidden h-[calc(100vh-3.5rem)] w-72 shrink-0 border-r border-border/60 bg-muted/20 lg:block">
...
function flattenTree(nodes: PageTree.Node[]): Array<{ name: ReactNode; url: string }> {
